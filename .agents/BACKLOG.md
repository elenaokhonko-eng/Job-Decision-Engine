...
| P1-04 | decision-policy-engineer | Replace budget-cap rejection with durable deferral and fair per-lane selection | P0-04, P1-03 | Eligible jobs are enqueueable without per-lane business quotas; capacity limits never become rejections | DONE | Explanation queue enqueuer is unbounded; no `DEFERRED_BUDGET` writes |
