...
ALTER TABLE canonical_jobs ADD COLUMN IF NOT EXISTS location_normalized TEXT DEFAULT 'Unknown';
ALTER TABLE canonical_jobs ADD COLUMN IF NOT EXISTS workplace_type VARCHAR(50) DEFAULT 'UNKNOWN';
ALTER TABLE canonical_jobs ADD COLUMN IF NOT EXISTS workplace_type_normalized VARCHAR(50) DEFAULT 'UNKNOWN';
