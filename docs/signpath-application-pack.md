...
5. Local-First & BYOK Privacy: Runs locally as a standalone Electron desktop app. User data is stored in their private PostgreSQL instance. Generative AI evaluation (Google Gemini or OpenAI) uses the personal API key configured by the desktop user as part of normal pipeline operation.
